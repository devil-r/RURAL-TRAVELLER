...
public class my_account_mypackages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent1=new Intent(my_account_mypackages.this,packages.class);
    ...
    private void GetWishlist() {
        ...
        FirebaseDatabase.getInstance().getReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    try {
                        for (DataSnapshot snapshot : dataSnapshot.child("my_packages").child(id).getChildren()) {
                            String name = null;
                    ...
                    catch (Exception e)
                    {
                        ...
                        Toast.makeText(my_account_mypackages.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
